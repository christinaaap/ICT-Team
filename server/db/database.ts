...
class Database {
  ...
  public updateTicketStatus(
    ...
    notes?: string,
    assignment?: { assigned_to?: string; assigned_to_name?: string; assigned_to_id?: number; picked_up_at?: string }
  ): Ticket | null {
    ...
    this.tickets[idx] = {
      ...this.tickets[idx],
      status,
      resolution_notes: notes !== undefined ? notes : this.tickets[idx].resolution_notes,
      assigned_to: assignment?.assigned_to !== undefined ? assignment.assigned_to : this.tickets[idx].assigned_to,
      assigned_to_name: assignment?.assigned_to_name !== undefined ? assignment.assigned_to_name : this.tickets[idx].assigned_to_name,
      assigned_to_id: assignment?.assigned_to_id !== undefined ? assignment.assigned_to_id : this.tickets[idx].assigned_to_id,
      picked_up_at: assignment?.picked_up_at !== undefined ? assignment.picked_up_at : this.tickets[idx].picked_up_at,
